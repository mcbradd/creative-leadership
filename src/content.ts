...
export const jointInsights: Record<"tetris" | "crayola", Insight> = {
  tetris: {
    ...
    proof: ["The internal production record describes a five-day recovery sprint involving more than 20 artists. Leadership in Southern California coordinated teams in Bucharest, Romania and Guadalajara, Mexico across two continents and multiple time zones, including training the Guadalajara VFX, 3D, and UI artists.", "The original scope covered 12 songs. Two songs were added before release for 14 levels at launch, then two funded postlaunch seasons of 14 songs each added 28 more for 42 total live levels.", "The title released eight months after the recovery period described by the team. Internal performance reporting says the game remained at or near the top of Apple Arcade for more than six weeks."],
